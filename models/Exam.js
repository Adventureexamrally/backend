...
const ExamSchema = new mongoose.Schema({
  ...
  test_type: { type: String, enum: ["Prelims", "Mains", "None"], default: "None" },
  time: { type: String, enum: ["Composite", "Sectional"], default: "Composite" },
  ...
  q_level: { type: String, enum: ["easy", "medium", "hard"], default: "medium" },
